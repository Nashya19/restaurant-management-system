 ...
 * Admin only (RLS enforces)
 */
export async function createMenuItem({ name, categoryId, price, prepTime, imageUrl = null }) {
  const supabase = createClient();
 ...
 */
export async function updateMenuItem(itemId, { name, categoryId, price, prepTime, isAvailable, isArchived, imageUrl = null }) {
  const supabase = createClient();
